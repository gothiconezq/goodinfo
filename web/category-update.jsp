		...
		<div class="row">
			...
			<div class="col-md-3">
				<div class="list-group">
					<a href="${pageContext.request.contextPath}//category?method=getCategoryList&currentPage=1&currentCount=10" class="list-group-item text-center ">商品列表</a>
					<a href="${pageContext.request.contextPath}/category-add.jsp" class="list-group-item text-center ">新增商品</a>
					<a href="${pageContext.request.contextPath}/layout-update.jsp" class="list-group-item text-center active">修改商品信息</a>
					...
					<div class="panel-body">
						<form action="category" method="post" class="form-horizontal" role="form">
							<div class="form-group">
								...
								<div class="col-sm-5">
									<input type="text" name="c_name" value="${param.c_name}" class="form-control" placeholder="商品名称">
								</div>
								<div class="col-sm-5">
							...
							<div class="form-group">
								...
								<div class="col-sm-5">
									<label class="radio-inline">
										<input <c:if test="${param.type==0}">checked="checked"</c:if> type="radio" name="type" value="0">其他
									</label>
									<label class="radio-inline">
										<input <c:if test="${param.type==1}">checked="checked"</c:if> type="radio" name="type" value="1">禽畜
									</label>
									<label class="radio-inline">
										<input <c:if test="${param.type==2}">checked="checked"</c:if> type="radio" name="type" value="2">水产
									</label>
								</div>
								<div class="col-sm-5">
...
<div class="jumbotron" style=" margin-bottom:0;margin-top:105px;">
	<div class="container">
	<span>&copy; 2018 GothicOnezq</span>
	</div>
</div>
