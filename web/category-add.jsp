            ...
            <div class="col-md-3">
                <div class="list-group">
                    ...
                    <a href="${pageContext.request.contextPath}/layout-form.html"
                       class="list-group-item text-center active">新增商品</a>
                </div>
            </div>
            <!-- 右侧内容 -->
            <div class="col-md-9">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">新增商品种类</div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <label class="radio-inline">
                                        <input type="radio" name="type" value="0">其他种类
                                    </label>
                                    <label class="radio-inline">
                                        <input type="radio" name="type" value="1">禽畜
                                    </label>
                                    <label class="radio-inline">
                                        <input type="radio" name="type" value="2">水产
                                    </label>
                                </div>
                                <div class="col-sm-5">
